    ...
    <Sonner
      ...
      toastOptions={{
        classNames: {
          ...
          actionButton:
            'group-[.toast]:bg-teal-600 group-[.toast]:text-white group-[.toast]:font-semibold',
          cancelButton:
          ...
          info:
            'group-[.toaster]:text-teal-950 group-[.toaster]:border-teal-200 group-[.toaster]:bg-teal-50',
        },
      }}
      {...props}
    />
