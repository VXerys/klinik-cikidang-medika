    ...
    <div className="bg-white p-4 sm:p-5 rounded-2xl border border-slate-200 shadow-xs space-y-4">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-slate-100 pb-3">
        <div className="flex items-center gap-2 text-xs font-bold text-slate-800 uppercase tracking-wider">
          <Funnel weight="duotone" className="w-4 h-4 text-blue-600" />
        ...
        <div className="flex flex-wrap items-center gap-1.5 text-xs">
          ...
          <button
            ...
            className="px-3 py-2 min-h-[44px] bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-xl font-medium transition text-xs flex items-center justify-center"
          >
            Bulan Ini
          </button>
          <button
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
        ...
        <div className="space-y-1.5">
          <label className="text-xs font-semibold text-slate-700 flex items-center gap-1.5">
            <UserCheck weight="duotone" className="w-4 h-4 text-slate-400" />
        ...
        <div className="space-y-1.5">
          <label className="text-xs font-semibold text-slate-700 flex items-center gap-1.5">
            <Stethoscope weight="duotone" className="w-4 h-4 text-slate-400" />
